...
export class ArticleService {
  private apiUrl = 'https://jsonplaceholder.typicode.com/posts'; //Cette URL nous permet de récupérer les posts
  ...
  // Méthide pour mettre à jour un post en récupérant l'id du post typé et les données du post typées également
